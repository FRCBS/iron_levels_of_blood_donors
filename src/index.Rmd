...
Results show that an increase in 1 point of BMI age results in a `r round(brm_coeffs %>% filter(Regressor == "BMI") %>% magrittr::extract2("Odds.Ratio")-1,3)*-100` % decrease in your odds by of feeling in very good pr excellent compared to satisfactory or good. An increase in one scale point in exercise frequency results in an increase of `r round(brm_coeffs %>% filter(Regressor == "physical_act_freq_n") %>% magrittr::extract2("Odds.Ratio")-1,3)*100`% of your odds of felling in excellent health compared to very good, good or satisfactory health. 
